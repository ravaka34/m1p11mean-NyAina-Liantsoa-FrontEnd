...
!(function (e, t) {
  ...
  function P(e, t, i) {
    var n = "string" == typeof t,
      ...
      s = e.replace(x, ""),
      r = E[s];
    return r && (s = r), M.has(s) || (s = e), [n, o, s];
  }
  ...
  var j = {
        ...
        if ("string" == typeof t && e) {
          ...
          if (void 0 === r) {
              ...
              Object.keys(d).forEach(function (i) {
                !(function (e, t, i, n) {
                  ...
                  Object.keys(o).forEach(function (s) {
                    if (s.includes(n)) {
                      var r = o[s];
                      W(e, t, i, r.originalHandler, r.delegationSelector);
                    }
                  });
                })(e, d, i, t.slice(1));
              });
            ...
            Object.keys(c).forEach(function (i) {
              ...
              if (!l || t.includes(n)) {
                var o = c[i];
                W(e, d, a, o.originalHandler, o.delegationSelector);
              }
            });
          } else {
            if (!d || !d[a]) return;
      ...
      trigger: function (e, t, i) {
        ...
        return (
          ...
          a
            ? (c = document.createEvent("HTMLEvents")).initEvent(s, l, !0)
          ...
          u && c.preventDefault(),
          d && e.dispatchEvent(c),
          c.defaultPrevented && void 0 !== n && n.preventDefault(),
          c
        );
      },
    },
  ...
  j.on(
    ...
    b(function () {
      ...
      if (e) {
        var t = e.fn[N];
        (e.fn[N] = $.jQueryInterface),
          (e.fn[N].Constructor = $),
          (e.fn[N].noConflict = function () {
            return (e.fn[N] = t), $.jQueryInterface;
          });
      }
    });
  var F = (function (e) {
  ...
  var Y = {
      ...
      getDataAttribute: function (e, t) {
        return B(e.getAttribute("data-bs-" + R(t)));
      },
      offset: function (e) {
  ...
  j.on(
    ...
    j.on(window, "load.bs.carousel.data-api", function () {
      for (
        ...
        K.carouselInterface(e[t], T(e[t], "bs.carousel"));
    }),
    b(function () {
      var e = y();
      if (e) {
  ...
  var X = "collapse",
    ...
    ee = (function (e) {
      function o(t, i) {
        ...
        for (
          var o = q.find('[data-bs-toggle="collapse"]'), s = 0, r = o.length;
          s < r;
          s++
        ) {
          var a = o[s],
            d = l(a),
            u = q.find(d).filter(function (e) {
              return e === t;
            });
          null !== d &&
            u.length &&
      ...
      return (
        ...
        (s._getConfig = function (e) {
          return ((e = i({}, G, e)).toggle = Boolean(e.toggle)), p(X, e, Z), e;
        }),
  ...
  j.on(
    ...
    b(function () {
      ...
      if (e) {
        var t = e.fn[X];
        (e.fn[X] = ee.jQueryInterface),
          (e.fn[X].Constructor = ee),
          (e.fn[X].noConflict = function () {
            return (e.fn[X] = t), ee.jQueryInterface;
          });
      }
    });
  var te = "top",
  ...
  function be(e) {
    return (
      (ce(e) ? e.ownerDocument : e.document) || window.document
    ).documentElement;
  }
  function _e(e) {
    return "html" === de(e)
  ...
  function ke(e) {
    for (var t = ue(e), i = we(e); i && ye(i) && "static" === ve(i).position; )
      i = we(i);
      ...
      fn: function (e) {
        ...
        if (o && s) {
          var d = i.modifiersData[n + "#persistent"].padding,
            ...
            w = Se(y, _, b),
            k = a;
          i.modifiersData[n] = (((t = {})[k] = w), (t.centerOffset = w - _), t);
        }
      },
      effect: function (e) {
        var t = e.state,
        ...
        null != s &&
          ...
          (t.modifiersData[n + "#persistent"] = {
            padding: xe("number" != typeof a ? a : Ce(a, se)),
          }));
      },
  ...
  function Ee(e) {
    ...
    if (l) {
      ...
      v === ue(i) && (v = be(i)),
        o === te &&
          ((m = ie), (c -= v.clientHeight - n.height), (c *= a ? 1 : -1)),
        o === oe &&
          ((p = ne), (u -= v.clientWidth - n.width), (u *= a ? 1 : -1));
    }
    var y,
      b = Object.assign({ position: r }, l && Oe);
    return a
      ? Object.assign(
          Object.assign({}, b),
          {},
  ...
  function Ne(e) {
    return je(be(e)).left + He(e).scrollLeft;
  }
  function $e(e) {
    var t = ve(e),
      i = t.overflow,
  ...
  function Fe(e, t) {
    ...
    var i = (function e(t) {
      ...
      n = "body" === de(i),
      o = ue(i),
      s = n ? [o].concat(o.visualViewport || [], $e(i) ? i : []) : i,
      r = t.concat(s);
  ...
  function qe(e) {
    ...
    if (null != d) {
      ...
      switch (r) {
        case "start":
          t[d] = Math.floor(t[d]) - Math.floor(i[u] / 2 - n[u] / 2);
          break;
        case "end":
          t[d] = Math.floor(t[d]) + Math.ceil(i[u] / 2 - n[u] / 2);
      }
    }
    return t;
  }
  function Ue(e, t) {
    ...
    var i = t,
      ...
      f = i.padding,
      p = void 0 === f ? 0 : f,
      m = xe("number" != typeof p ? p : Ce(p, se)),
      ...
      })(ce(b) ? b : b.contextElement || be(e.elements.popper), r, l),
      w = je(v),
      k = qe({ reference: w, element: y, strategy: "absolute", placement: o }),
      T = Be(Object.assign(Object.assign({}, y), k)),
      S = "popper" === u ? T : w,
      x = {
      ...
      fn: function (e) {
        ...
        (t.modifiersData[i] = {
          ...
          (t.attributes.popper = Object.assign(
            Object.assign({}, t.attributes.popper),
            {},
            { "data-popper-reference-hidden": u, "data-popper-escaped": c }
          ));
      },
    },
    Xe = {
        ...
        if (k) {
          if (s) {
            var D = "y" === _ ? te : oe,
              ...
              $ = H[O],
              F = Se(0, T[E], j[E]),
              B = b ? T[E] / 2 - L - F - N - x : P - F - N - x,
              R = b ? -T[E] / 2 + L + F + $ + x : z + F + $ + x,
              ...
              V = k[_] + B - U - q,
              J = k[_] + R - U,
              Q = Se(f ? Math.min(A, V) : A, M, f ? Math.max(I, J) : I);
            (k[_] = Q), (C[_] = Q - M);
          }
          if (a) {
            var K = "x" === _ ? te : oe,
              ...
              if (it(t, i)) {
                ...
                for (var n = 0; n < a.orderedModifiers.length; n++)
                  if (!0 !== a.reset) {
                    ...
                    "function" == typeof s &&
                      (a =
                        s({ state: a, options: l, name: c, instance: u }) || a);
                  } else (a.reset = !1), (n = -1);
              }
            }
          },
  ...
  var ot = nt(),
    st = nt({ defaultModifiers: [Ie, Ge, Me, fe] }),
    rt = nt({ defaultModifiers: [Ie, Ge, Me, fe, Xe, Ve, Ze, De, Ke] }),
    at = Object.freeze({
      __proto__: null,
      popperGenerator: nt,
      detectOverflow: Ue,
    ...
    ut = _ ? "top-end" : "top-start",
    ct = _ ? "top-start" : "top-end",
    ht = _ ? "bottom-end" : "bottom-start",
    ft = _ ? "bottom-start" : "bottom-end",
        ...
        (s._getPlacement = function () {
          ...
          var t =
            ...
            getComputedStyle(this._menu)
              ...
              .trim();
          return e.classList.contains("dropup") ? (t ? ct : ut) : t ? ft : ht;
        }),
      ...
      return (
        ...
        (s._showBackdrop = function (e) {
          ...
          if (this._isShown && this._config.backdrop) {
            ...
            j.one(this._backdrop, "transitionend", e), f(this._backdrop, n);
  ...
  var Ct = "tooltip",
    ...
    Ot = new Set(["sanitize", "allowList", "sanitizeFn"]),
    Et = {
      animation: "boolean",
      template: "string",
      ...
      return (
            ...
            var c,
              ...
              p =
                "function" == typeof this.config.customClass
                  ...
                  : this.config.customClass;
            p && (c = o.classList).add.apply(c, p.split(" ")),
              "ontouchstart" in document.documentElement &&
                (h = []).concat
        ...
        (s._getConfig = function (e) {
          ...
          return (
            ...
            e.sanitize &&
              (e.template = xt(e.template, e.allowList, e.sanitizeFn)),
            e
          );
        }),
  ...
  b(function () {
    ...
    if (e) {
      var t = e.fn[Pt];
      (e.fn[Pt] = Nt.jQueryInterface),
        (e.fn[Pt].Constructor = Nt),
        (e.fn[Pt].noConflict = function () {
          return (e.fn[Pt] = t), Nt.jQueryInterface;
        });
    }
  });
  var $t = "scrollspy",
      ...
      return (
        ...
        (s._getConfig = function (e) {
          if (
            ...
            var t = e.target.id;
            t || ((t = r($t)), (e.target.id = t)), (e.target = "#" + t);
          }
          return p($t, e, Bt), e;
        }),
  ...
  j.on(window, "load.bs.scrollspy.data-api", function () {
    q.find('[data-bs-spy="scroll"]').forEach(function (e) {
      return new Rt(e, Y.getDataAttributes(e));
    });
  }),
    b(function () {
      var e = y();
      if (e) {
        var t = e.fn[$t];
        (e.fn[$t] = Rt.jQueryInterface),
          (e.fn[$t].Constructor = Rt),
          (e.fn[$t].noConflict = function () {
            return (e.fn[$t] = t), Rt.jQueryInterface;
          });
      }
    });
  var Yt = (function (e) {
        ...
        (s.show = function () {
          ...
          if (!j.trigger(this._element, "show.bs.toast").defaultPrevented) {
            ...
            if (
              ...
              j.one(this._element, "transitionend", t), f(this._element, i);
            } else t();
          }
        }),
        (s.hide = function () {
  ...
  (function (e, t) {
    ...
    return function n(a) {
      if (
        ...
        for (
          var u = (d.isBorderBox = "border-box" == l.boxSizing), c = 0;
          c < s;
          c++
        ) {
          var h = o[c],
    ...
    return (
      (i.htmlInit = function (t, n) {
        i.docReady(function () {
          ...
          d.forEach(function (e) {
            var i,
              s = e.getAttribute(r) || e.getAttribute(u);
            try {
              i = s && JSON.parse(s);
            } catch (i) {
              return void (
    ...
    (e.cleanData =
      ...
      (e.widget = function (t, i, n) {
        ...
        return (
          ...
          (s.prototype = e.widget.extend(
            ...
            a,
            { constructor: s, namespace: l, widgetName: t, widgetFullName: d }
          )),
          o
      ...
      e.each({ show: "fadeIn", hide: "fadeOut" }, function (t, i) {
        e.Widget.prototype["_" + t] = function (n, o, s) {
          ...
          var a = o ? (!0 !== o && "number" != typeof o && o.effect) || i : t;
    ...
    e(document).on("mouseup", function () {
      ...
      e.widget("ui.slider", e.ui.mouse, {
        ...
        values: function (t, i) {
          ...
          for (n = this.options.values, o = t, s = 0; s < n.length; s += 1)
          ...
          this._hasMultipleValues()
            ? this.handles.each(function (n) {
                (i =
                  ...
                  (u["horizontal" === l.orientation ? "left" : "bottom"] =
                    i + "%"),
                  e(this).stop(1, 1)[d ? "animate" : "css"](u, a.animate),
                  !0 === l.options.range &&
            ...
            : ((n = this.value()),
              ...
              (u["horizontal" === this.orientation ? "left" : "bottom"] =
                i + "%"),
              this.handle.stop(1, 1)[d ? "animate" : "css"](u, a.animate),
              "min" === r &&
                "horizontal" === this.orientation &&
                this.range
                  .stop(1, 1)
    ...
    (e = function (e, t) {
      ...
      (i = function (e) {
        ...
        for (e = e || {}, t = 1; t < arguments.length; t++)
          if ((n = arguments[t]))
            for (var o in n)
              n.hasOwnProperty(o) &&
                ("object" == typeof n[o] ? i(e[o], n[o]) : (e[o] = n[o]));
        return e;
      }),
      (n = function (e, t) {
        for (var i = 0; i < t.length; i++)
      ...
      ((DateFormatter = function (e) {
        ...
        parseDate: function (t, i) {
          ...
          if (!(n = i.match(f.validParts)) || 0 === n.length)
            throw new Error("Invalid date format definition.");
          for (
            o = t.replace(f.separators, "\0").split("\0"), s = 0;
            s < o.length;
            s++
          )
            switch (((r = o[s]), (a = parseInt(r)), n[s])) {
              ...
              case "Y":
                if (!a) return null;
                (c = r.length),
                  (v.year = 2 === c ? parseInt((a < 70 ? "20" : "19") + r) : a),
                  (p = !0);
                break;
              case "m":
              case "n":
              ...
              case "h":
                if (
                  ...
                  (u = e(h, g.meridiem[0]) ? 0 : e(h, g.meridiem[1]) ? 12 : -1),
                    1 <= a && a <= 12 && -1 < u
                      ? (v.hour = a + u - 1)
                      : 0 <= a && a <= 23 && (v.hour = a);
                else {
        ...
        guessDate: function (e, t) {
          ...
          for (o = 0; o < l.length; o++) {
            if (((c = 2), (r = l[o]), (a = parseInt(r.substr(0, 2))), isNaN(a)))
              return null;
            switch (o) {
              case 0:
                "m" === d[0] || "n" === d[0] ? u.setMonth(a - 1) : u.setDate(a);
                break;
              case 1:
                "m" === d[0] || "n" === d[0] ? u.setDate(a) : u.setMonth(a - 1);
                break;
              case 2:
                if (
                  ((n = u.getFullYear()),
                  (c = (i = r.length) < 4 ? i : 4),
                  !(n = parseInt(
                    i < 4 ? n.toString().substr(0, 4 - i) + r : r.substr(0, 4)
                  )))
                )
                  return null;
                u.setFullYear(n);
            ...
            0 < (s = r.substr(c)).length && l.splice(o + 1, 0, s);
          }
          return u;
        },
        parseFormat: function (e, i) {
          ...
          return (
            (n = {
              ...
              T: function () {
                return (
                  (String(i).match(o.tzParts) || [""])
                    .pop()
                    .replace(o.tzClip, "") || "UTC"
                );
              },
              Z: function () {
          ...
          if (e instanceof Date) {
            for (o = t.length, i = 0; i < o; i++)
              "S" !== (r = t.charAt(i)) &&
                ...
                (0 < i && "\\" === t.charAt(i - 1)
                  ? (a += r)
                  : ((s = this.parseFormat(r, e)),
                    i !== o - 1 &&
                      this.intParts.test(r) &&
                      "S" === t.charAt(i + 1) &&
                      ((n = parseInt(s) || 0),
          ...
          ? (e(this).hasClass("xdsoft_scroller_box") ||
              ...
              (v = function (e) {
                ...
                t < 0 && (t = 0),
                  ...
                  l.trigger("scroll_element.xdsoft_scroller", [u ? t / u : 0]);
              }),
              a
                .on(
              ...
              l
                .on("scroll_element.xdsoft_scroller", function (e, t) {
                  o || l.trigger("resize_scroll.xdsoft_scroller", [t, !0]),
                    ...
                    setTimeout(function () {
                      n.css(
                        "marginTop",
                        -parseInt((n[0].offsetHeight - o) * t, 10)
                      );
                    }, 10);
                })
                .on("resize_scroll.xdsoft_scroller", function (e, t, i) {
                  ...
                  (o = l[0].clientHeight),
                    (s = n[0].offsetHeight),
                    (c = (d = o / s) * r[0].offsetHeight),
                    1 < d
                      ? a.hide()
                      : (a.show(),
                        a.css("height", parseInt(10 < c ? c : 10, 10)),
              ...
              l.on("touchstart", function (e) {
                (c = d(e)), (f = Math.abs(parseInt(n.css("marginTop"), 10)));
              }),
      ...
      return (
        (r = function (t) {
          var s,
            ...
            $ = 0;
          x.id && O.attr("id", x.id),
            x.style && O.attr("style", x.style),
            x.weeks && O.addClass("xdsoft_showweeks"),
            x.rtl && O.addClass("xdsoft_rtl"),
            O.addClass("xdsoft_" + x.theme),
            O.addClass(x.className),
            A.find(".xdsoft_month span").after(j),
            A.find(".xdsoft_year span").after(H),
            A.find(".xdsoft_month,.xdsoft_year").on(
              ...
              function (t) {
                ...
                return (
                  o.xdsoftScroller(
                    x,
                    r / (o.children()[0].offsetHeight - o[0].clientHeight)
                  ),
                  t.stopPropagation(),
                  !1
                );
          ...
          var F = function (e) {
            ...
            Math.sqrt(n * n + o * o) > x.touchMovedThreshold &&
              (this.touchMoved = !0);
          };
          function B() {
            var e,
            ...
            return (
              x.startDate
                ? (i = C.strToDate(x.startDate))
                : (i = x.value || (t && t.val && t.val() ? t.val() : ""))
                ? ((i = C.strToDateTime(i)),
                  x.yearOffset &&
                    (i = new Date(
                      i.getFullYear() - x.yearOffset,
                      i.getMonth(),
                      i.getDate(),
                      i.getHours(),
                      i.getMinutes(),
                ...
                : x.defaultDate &&
                  ((i = C.strToDateTime(x.defaultDate)),
                  x.defaultTime &&
                    ((e = C.strtotime(x.defaultTime)),
                    i.setHours(e.getHours()),
                    i.setMinutes(e.getMinutes()))),
              i && C.isValidDate(i) ? O.data("changed", !0) : (i = ""),
              i || 0
            );
          }
          function R(n) {
                ...
                t.on("keydown.xdsoft", function (i) {
                  ...
                  if (
                    ...
                    for (
                      ...
                      var D = n.mask.substr(u, 1),
                        O = u < n.mask.length,
                        E = 0 < u;
                      if (!(/[^0-9_]/.test(D) && O && E)) break;
                      u += 8 !== l || C ? 1 : -1;
                    }
                    if ((i.metaKey && (C = !(u = 0)), C)) {
                      var M = x - u,
                        A = n.mask.replace(/[0-9]/g, "_"),
                        I = A.substr(u, M).substr(1);
                      a = a.substr(0, u) + (r + I) + a.substr(u + M);
                    } else a = a.substr(0, u) + r + a.substr(u + 1);
                    if ("" === e.trim(a)) a = A;
                    else if (u === n.mask.length) return i.preventDefault(), !1;
                    for (
                      u += 8 === l ? 0 : 1;
                      /[^0-9_]/.test(n.mask.substr(u, 1)) &&
                      u < n.mask.length &&
                      0 < u;
                      ...
                      u += 8 === l ? 0 : 1;
                    o(n.mask, a)
                      ? ((this.value = a), s(this, u))
                      : "" === e.trim(a)
                      ? (this.value = n.mask.replace(/[0-9]/g, "_"))
                      : t.trigger("error_input.xdsoft");
                  } else if ((-1 !== [b, _, w, k, T].indexOf(l) && S) || -1 !== [h, p, g, f, m, y, d, v, c].indexOf(l)) return !0;
          ...
          A.find(".xdsoft_select")
            ...
            .on("touchmove", ".xdsoft_option", F)
            .on("touchend mousedown.xdsoft", ".xdsoft_option", function () {
              if (!this.touchMoved) {
                (void 0 !== C.currentTime && null !== C.currentTime) ||
                  (C.currentTime = C.now());
                ...
                C &&
                  ...
                  x.onChangeMonth &&
                    e.isFunction(x.onChangeMonth) &&
                    x.onChangeMonth.call(O, C.currentTime, O.data("input")),
                  t !== C.currentTime.getFullYear() &&
                    e.isFunction(x.onChangeYear) &&
                    x.onChangeYear.call(O, C.currentTime, O.data("input"));
              }
            }),
            (O.getValue = function () {
            ...
            (O.setOptions = function (n) {
              ...
              (x = e.extend(!0, {}, x, n)),
                n.allowTimes &&
                  ...
                  n.allowTimes.length &&
                  (x.allowTimes = e.extend(!0, [], n.allowTimes)),
                n.weekends &&
                  e.isArray(n.weekends) &&
                  n.weekends.length &&
                  (x.weekends = e.extend(!0, [], n.weekends)),
                n.allowDates &&
                  e.isArray(n.allowDates) &&
                  n.allowDates.length &&
                  (x.allowDates = e.extend(!0, [], n.allowDates)),
                n.allowDateRe &&
                  "[object String]" ===
                    Object.prototype.toString.call(n.allowDateRe) &&
                  (x.allowDateRe = new RegExp(n.allowDateRe)),
                n.highlightedDates &&
                  ...
                  (e.each(n.highlightedDates, function (t, n) {
                    var s,
                      ...
                      a = new u(i.parseDate(r[0], x.formatDate), r[1], r[2]),
                      l = i.formatDate(a.date, x.formatDate);
                    void 0 !== o[l]
                      ? (s = o[l].desc) &&
                        s.length &&
                        a.desc &&
                ...
                n.disabledDates &&
                  ...
                  (x.disabledDates = e.extend(!0, [], n.disabledDates)),
                n.disabledWeekDays &&
                  e.isArray(n.disabledWeekDays) &&
                  n.disabledWeekDays.length &&
                  (x.disabledWeekDays = e.extend(!0, [], n.disabledWeekDays)),
                (!x.open && !x.opened) || x.inline || t.trigger("open.xdsoft"),
                x.inline &&
                  ((N = !0), O.addClass("xdsoft_inline"), t.after(O).hide()),
                x.inverseButton &&
                  ((x.next = "xdsoft_prev"), (x.prev = "xdsoft_next")),
                x.datepicker ? M.addClass("active") : M.removeClass("active"),
                x.timepicker ? L.addClass("active") : L.removeClass("active"),
                x.value &&
                  (C.setCurrentTime(x.value), t && t.val && t.val(C.str)),
                isNaN(x.dayOfWeekStart)
                  ? (x.dayOfWeekStart = 0)
                  : (x.dayOfWeekStart = parseInt(x.dayOfWeekStart, 10) % 7),
                x.timepickerScrollbar || P.xdsoftScroller(x, "hide"),
                x.minDate &&
                  /^[\+\-](.*)$/.test(x.minDate) &&
                  (x.minDate = i.formatDate(
                    C.strToDateTime(x.minDate),
                    x.formatDate
                  )),
                x.maxDate &&
                  /^[\+\-](.*)$/.test(x.maxDate) &&
                  (x.maxDate = i.formatDate(
                    C.strToDateTime(x.maxDate),
                    x.formatDate
                  )),
                x.minDateTime &&
                  /^\+(.*)$/.test(x.minDateTime) &&
                  (x.minDateTime = C.strToDateTime(x.minDateTime).dateFormat(
                    x.formatDate
                  )),
                x.maxDateTime &&
                  /^\+(.*)$/.test(x.maxDateTime) &&
                  (x.maxDateTime = C.strToDateTime(x.maxDateTime).dateFormat(
                    x.formatDate
                  )),
                W.toggle(x.showApplyButton),
                A.find(".xdsoft_today_button").css(
                  "visibility",
                  x.todayButton ? "visible" : "hidden"
                ),
                A.find("." + x.prev).css(
                  "visibility",
                  x.prevButton ? "visible" : "hidden"
                ),
                A.find("." + x.next).css(
                  "visibility",
                  x.nextButton ? "visible" : "hidden"
                ),
                R(x),
                x.validateOnBlur &&
                  t.off("blur.xdsoft").on("blur.xdsoft", function () {
                    if (
                      ...
                      (!e.trim(e(this).val()).length ||
                        ("string" == typeof x.mask &&
                          e.trim(e(this).val()) ===
                            x.mask.replace(/[0-9]/g, "_")))
                    )
                      e(this).val(null), O.data("xdsoft_datetime").empty();
                    else {
                      var t = i.parseDate(e(this).val(), x.format);
                      if (t) e(this).val(i.formatDate(t, x.format));
                      else {
                        ...
                        o < 60
                          ...
                          : e(this).val(i.formatDate(C.now(), x.format));
                      }
                ...
                (x.dayOfWeekStartPrev =
                  0 === x.dayOfWeekStart ? 6 : x.dayOfWeekStart - 1),
            ...
            O.append(M).append(L),
            !0 !== x.withoutCopyright && O.append(E),
            M.append(A).append(I).append(W),
            x.insideParent ? e(t).parent().append(O) : e(x.parentID).append(O),
            (C = new (function () {
              var t = this;
              (t.now = function (e) {
                var i,
                ...
                return (
                  !e &&
                    x.defaultDate &&
                    ((i = t.strToDateTime(x.defaultDate)),
                ...
                (t.getWeekOfYear = function (t) {
                  if (x.onGetWeekOfYear && e.isFunction(x.onGetWeekOfYear)) {
                    var i = x.onGetWeekOfYear.call(O, t);
                ...
                (t.strToDateTime = function (e) {
                  ...
                  return e && e instanceof Date && t.isValidDate(e)
                    ? e
                    : ((s = /^([+-]{1})(.*)$/.exec(e)) &&
                        (s[2] = i.parseDate(s[2], x.formatDate)),
                      (o =
                        s && s[2]
                          ? ((n =
                              s[2].getTime() - 6e4 * s[2].getTimezoneOffset()),
                            new Date(
                              t.now(!0).getTime() + parseInt(s[1] + "1", 10) * n
                            ))
                          : e
                          ? i.parseDate(e, x.format)
                          : t.now()),
                ...
                (t.strToDate = function (e) {
                  ...
                  var n = e ? i.parseDate(e, x.formatDate) : t.now(!0);
                  return t.isValidDate(n) || (n = t.now(!0)), n;
                }),
                (t.strtotime = function (e) {
                  if (e && e instanceof Date && t.isValidDate(e)) return e;
                  var n = e ? i.parseDate(e, x.formatTime) : t.now(!0);
                  return t.isValidDate(n) || (n = t.now(!0)), n;
                }),
                (t.str = function () {
                  var e = x.format;
                  return (
                    x.yearOffset &&
                      (e = (e = e.replace(
                        "Y",
                        t.currentTime.getFullYear() + x.yearOffset
                      )).replace(
                        "y",
                        String(
                          t.currentTime.getFullYear() + x.yearOffset
            ...
            A.find(".xdsoft_prev,.xdsoft_next").on(
              ...
              function () {
                ...
                !(function e(o) {
                  t.hasClass(x.next)
                    ? C.nextMonth()
                    : t.hasClass(x.prev) && C.prevMonth(),
                    x.monthChangeSpinner &&
                      (n || (i = setTimeout(e, o || 100)));
                })(500),
                  e([x.ownerDocument.body, x.contentWindow]).on(
                    "touchend mouseup.xdsoft",
                    function t() {
                      clearTimeout(i),
                        (n = !0),
                        e([x.ownerDocument.body, x.contentWindow]).off(
                          "touchend mouseup.xdsoft",
                          t
                        );
                    }
            ...
            L.find(".xdsoft_prev,.xdsoft_next").on(
              ...
              function () {
                ...
                !(function e(s) {
                  ...
                  t.hasClass(x.next) && a - r - x.timeHeightInTimePicker >= l
                    ? z.css(
                        "marginTop",
                        "-" + (l + x.timeHeightInTimePicker) + "px"
                      )
                    : t.hasClass(x.prev) &&
                      0 <= l - x.timeHeightInTimePicker &&
                      z.css(
                        "marginTop",
                        "-" + (l - x.timeHeightInTimePicker) + "px"
                      ),
                    P.trigger("scroll_element.xdsoft_scroller", [
                      Math.abs(parseInt(z[0].style.marginTop, 10) / (a - r)),
                    ]),
                    (o = 10 < o ? 10 : o - 10),
            ...
            (s = 0),
            O.on("xchange.xdsoft", function (r) {
              clearTimeout(s),
                (s = setTimeout(function () {
                  ...
                  for (
                    ...
                    m +=
                      "<th>" +
                      x.i18n[o].dayOfWeekShort[(s + x.dayOfWeekStart) % 7] +
                      "</th>";
                  for (
                    m += "</tr></thead>",
                      m += "<tbody>",
                      !1 !== x.maxDate &&
                        ((b = C.strToDate(x.maxDate)),
                        (b = new Date(
                          b.getFullYear(),
                          b.getMonth(),
                          b.getDate(),
                      ...
                      !1 !== k &&
                        (p =
                          ...
                          k.getDate());
                    v < C.currentTime.countDaysInMonth() ||
                    g.getDay() !== x.dayOfWeekStart ||
                    C.currentTime.getMonth() === g.getMonth();
                    ...
                    (T = []),
                      ...
                      T.push("xdsoft_date"),
                      (c =
                        x.beforeShowDay && e.isFunction(x.beforeShowDay.call)
                          ? x.beforeShowDay.call(O, g)
                          : null),
                      x.allowDateRe &&
                        "[object RegExp]" ===
                          Object.prototype.toString.call(x.allowDateRe) &&
                        (x.allowDateRe.test(i.formatDate(g, x.formatDate)) ||
                          T.push("xdsoft_disabled")),
                      x.allowDates &&
                        0 < x.allowDates.length &&
                        -1 ===
                          x.allowDates.indexOf(i.formatDate(g, x.formatDate)) &&
                        T.push("xdsoft_disabled");
                    var E =
                    ...
                    ((!1 !== b && b < g) ||
                      ...
                      T.push("xdsoft_disabled"),
                      -1 !==
                        x.disabledDates.indexOf(
                          i.formatDate(g, x.formatDate)
                        ) && T.push("xdsoft_disabled"),
                      -1 !== x.disabledWeekDays.indexOf(a) &&
                        T.push("xdsoft_disabled"),
                      t.is("[disabled]") && T.push("xdsoft_disabled"),
                      c && "" !== c[1] && T.push(c[1]),
                      C.currentTime.getMonth() !== W &&
                        T.push("xdsoft_other_month"),
                      (x.defaultSelect || O.data("changed")) &&
                        i.formatDate(C.currentTime, x.formatDate) ===
                          i.formatDate(g, x.formatDate) &&
                        T.push("xdsoft_current"),
                      i.formatDate(y, x.formatDate) ===
                        i.formatDate(g, x.formatDate) && T.push("xdsoft_today"),
                      (0 !== g.getDay() &&
                        6 !== g.getDay() &&
                        -1 ===
                          x.weekends.indexOf(i.formatDate(g, x.formatDate))) ||
                        T.push("xdsoft_weekend"),
                      void 0 !==
                        x.highlightedDates[i.formatDate(g, x.formatDate)] &&
                        ((r =
                          x.highlightedDates[i.formatDate(g, x.formatDate)]),
                        T.push(
                          void 0 === r.style
                        ...
                        (f = void 0 === r.desc ? "" : r.desc)),
                      x.beforeShowDay &&
                        e.isFunction(x.beforeShowDay) &&
                        T.push(x.beforeShowDay(g)),
                      S &&
                        ((m += "<tr>"),
                        (S = !1),
                        x.weeks && (m += "<th>" + u + "</th>")),
                  ...
                  (m += "</tbody></table>"),
                    ...
                    A.find(".xdsoft_label span")
                      .eq(0)
                      .text(x.i18n[o].months[C.currentTime.getMonth()]),
                    A.find(".xdsoft_label span")
                      .eq(1)
                      .text(C.currentTime.getFullYear() + x.yearOffset),
                    (W = D = "");
                  var M = 0;
                  if (!1 !== x.minTime) {
                    var L = C.strtotime(x.minTime);
                    M = 60 * L.getHours() + L.getMinutes();
                  }
                  var P = 1440;
                  if (
                    (!1 !== x.maxTime &&
                      ((L = C.strtotime(x.maxTime)),
                      (P = 60 * L.getHours() + L.getMinutes())),
                    !1 !== x.minDateTime &&
                      ((L = C.strToDateTime(x.minDateTime)),
                      i.formatDate(C.currentTime, x.formatDate) ===
                  ...
                  if (
                    (!1 !== x.maxDateTime &&
                      ((L = C.strToDateTime(x.maxDateTime)),
                      i.formatDate(C.currentTime, x.formatDate) ===
                        i.formatDate(L, x.formatDate) &&
                        (W = 60 * L.getHours() + L.getMinutes()) < P &&
                        (P = W)),
                    (h = function (n, o) {
                      var s,
                        r = C.now(),
                      ...
                      r.setHours(n),
                        ...
                        (T = []);
                      var l = 60 * n + o;
                      (t.is("[disabled]") || P <= l || l < M) &&
                        T.push("xdsoft_disabled"),
                        (s = new Date(C.currentTime)).setHours(
                          parseInt(C.currentTime.getHours(), 10)
                        ),
                        a ||
                          s.setMinutes(
                            Math[x.roundTime](
                              C.currentTime.getMinutes() / x.step
                            ) * x.step
                          ),
                        (x.initTime || x.defaultSelect || O.data("changed")) &&
                          s.getHours() === parseInt(n, 10) &&
                          ((!a && 59 < x.step) ||
                            s.getMinutes() === parseInt(o, 10)) &&
                          (x.defaultSelect || O.data("changed")
                            ? T.push("xdsoft_current")
                            : x.initTime && T.push("xdsoft_init_time")),
                        parseInt(y.getHours(), 10) === parseInt(n, 10) &&
                          parseInt(y.getMinutes(), 10) === parseInt(o, 10) &&
                          T.push("xdsoft_today"),
                        (D +=
                    ...
                    for (v = 0; v < x.allowTimes.length; v += 1)
                      h(
                        C.strtotime(x.allowTimes[v]).getHours(),
                        (W = C.strtotime(x.allowTimes[v]).getMinutes())
                      );
                  else
                    for (s = v = 0; v < (x.hours12 ? 12 : 24); v += 1)
                      for (s = 0; s < 60; s += x.step) {
                        var N = 60 * v + s;
                        N < M ||
                          P <= N ||
                          h(
                  ...
                  for (
                    z.html(D), n = "", v = parseInt(x.yearStart, 10);
                    v <= parseInt(x.yearEnd, 10);
                    v += 1
                  )
                    n +=
                      '<div class="xdsoft_option ' +
                      (C.currentTime.getFullYear() === v
                        ? "xdsoft_current"
                        : "") +
                      '" data-value="' +
                      v +
                      ...
                      "</div>";
                  for (
                    H.children().eq(0).html(n),
                      v = parseInt(x.monthStart, 10),
                      n = "";
                    v <= parseInt(x.monthEnd, 10);
                    v += 1
                  )
                    n +=
                      '<div class="xdsoft_option ' +
                      (C.currentTime.getMonth() === v ? "xdsoft_current" : "") +
                      '" data-value="' +
                      v +
                      '">' +
                      x.i18n[o].months[v] +
                      "</div>";
                  j.children().eq(0).html(n), e(O).trigger("generate.xdsoft");
                }, 10)),
                r.stopPropagation();
                ...
                e
                  ? ((t = P[0].clientHeight),
                    (i = z[0].offsetHeight) - t <
                      (n = z.find(e).index() * x.timeHeightInTimePicker + 1) &&
                      (n = i - t),
                    P.trigger("scroll_element.xdsoft_scroller", [
                      parseInt(n, 10) / (i - t),
                    ]))
            ...
            (r = 0),
            I.on("touchend click.xdsoft", "td", function (i) {
              i.stopPropagation(), (r += 1);
              var n = e(this),
                o = C.currentTime;
              if (
                (null == o && ((C.currentTime = C.now()), (o = C.currentTime)),
              ...
              o.setDate(1),
                ...
                O.trigger("select.xdsoft", [o]),
                t.val(C.str()),
                x.onSelectDate &&
                  e.isFunction(x.onSelectDate) &&
                  x.onSelectDate.call(O, C.currentTime, O.data("input"), i),
                O.data("changed", !0),
                O.trigger("xchange.xdsoft"),
                O.trigger("changedatetime.xdsoft"),
                (1 < r ||
                  !0 === x.closeOnDateSelect ||
                  (!1 === x.closeOnDateSelect && !x.timepicker)) &&
                  !x.inline &&
                  O.trigger("close.xdsoft"),
                setTimeout(function () {
                  r = 0;
            ...
            z
              ...
              .on("touchend click.xdsoft", "div", function (t) {
                if (!this.touchMoved) {
                  ...
                  if (
                    (null == n &&
                      ((C.currentTime = C.now()), (n = C.currentTime)),
                  ...
                  n.setHours(i.data("hour")),
                    ...
                    O.data("input").val(C.str()),
                    x.onSelectTime &&
                      e.isFunction(x.onSelectTime) &&
                      x.onSelectTime.call(O, C.currentTime, O.data("input"), t),
                    O.data("changed", !0),
                    O.trigger("xchange.xdsoft"),
                    O.trigger("changedatetime.xdsoft"),
                    !0 !== x.inline &&
                      !0 === x.closeOnTimeSelect &&
                      O.trigger("close.xdsoft");
                }
              }),
            M.on("mousewheel.xdsoft", function (e) {
              return (
                !x.scrollMonth ||
                (e.deltaY < 0 ? C.nextMonth() : C.prevMonth(), !1)
              );
            }),
            t.on("mousewheel.xdsoft", function (e) {
              return (
                !x.scrollInput ||
                (!x.datepicker && x.timepicker
                  ? (0 <=
                    ...
                    !1)
                  : x.datepicker && !x.timepicker
                  ? (M.trigger(e, [e.deltaY, e.deltaX, e.deltaY]),
                    t.val && t.val(C.str()),
                    O.trigger("changedatetime.xdsoft"),
                    !1)
                  : void 0)
            ...
            O.on("changedatetime.xdsoft", function (t) {
              if (x.onChangeDateTime && e.isFunction(x.onChangeDateTime)) {
                var i = O.data("input");
                x.onChangeDateTime.call(O, C.currentTime, i, t),
                  delete x.value,
                  i.trigger("change");
              }
            })
              .on("generate.xdsoft", function () {
                x.onGenerate &&
                  e.isFunction(x.onGenerate) &&
                  x.onGenerate.call(O, C.currentTime, O.data("input")),
                  N && (O.trigger("afterOpen.xdsoft"), (N = !1));
              })
            ...
            (l = function () {
              var t, i, n, o, s, r, a, l, d, u, c, h, f;
              if (
                ((t = (l = O.data("input")).offset()),
                (i = l[0]),
                (u = "top"),
                (n = t.top + i.offsetHeight - 1),
                (o = t.left),
                (s = "absolute"),
                (d = e(x.contentWindow).width()),
                (h = e(x.contentWindow).height()),
                (f = e(x.contentWindow).scrollTop()),
                x.ownerDocument.documentElement.clientWidth - t.left <
              ...
              "rtl" === l.parent().css("direction") &&
                (o -= O.outerWidth() - l.outerWidth()),
                x.fixed
                  ? ((n -= f),
                    (o -= e(x.contentWindow).scrollLeft()),
                    (s = "fixed"))
                  : ((a = !1),
                    D(i, function (e) {
                      return (
                    ...
                    a && !x.insideParent
                      ? ((s = "fixed"),
                        n + O.outerHeight() > h + f
                          ? ((u = "bottom"), (n = h + f - t.top))
                          : (n -= f))
                      : n + O[0].offsetHeight > h + f &&
                        (n = t.top - O[0].offsetHeight + 1),
                    n < 0 && (n = 0),
                ...
                (c = {
                  position: s,
                  left: x.insideParent ? i.offsetLeft : o,
                  top: "",
                  bottom: "",
                }),
                x.insideParent
                  ? (c[u] = i.offsetTop + i.offsetHeight)
                  : (c[u] = n),
                O.css(c);
            }),
            O.on("open.xdsoft", function (t) {
              var i = !0;
              x.onShow &&
                e.isFunction(x.onShow) &&
                (i = x.onShow.call(O, C.currentTime, O.data("input"), t)),
                !1 !== i &&
                  (O.show(),
                  l(),
                  e(x.contentWindow)
              ...
              .on("close.xdsoft", function (t) {
                var i = !0;
                A.find(".xdsoft_month,.xdsoft_year")
                  .find(".xdsoft_select")
                  .hide(),
                  x.onClose &&
                    e.isFunction(x.onClose) &&
                    (i = x.onClose.call(O, C.currentTime, O.data("input"), t)),
                  !1 === i || x.opened || x.inline || O.hide(),
                  t.stopPropagation();
              })
            ...
            t
              ...
              .on("keydown.xdsoft", function (t) {
                var i,
                  n = t.which;
                return -1 !== [c].indexOf(n) && x.enterLikeTab
                  ? ((i = e(
        ...
        (a = function (t) {
          ...
          i &&
            ...
            e(x.contentWindow).off("resize.xdsoft"),
            e([x.contentWindow, x.ownerDocument.body]).off(
                  ...
                  (this.value = this.defaultValue),
                    (this.value &&
                      o
                        ...
                        .isValidDate(i.parseDate(this.value, x.format))) ||
                      o.data("changed", !1),
...
!(function (e) {
  ...
  (function (e) {
    ...
    function l(n) {
      ...
      if (
        ...
        "axis" in r && r.axis === r.HORIZONTAL_AXIS && ((h = -1 * f), (f = 0)),
        (c = 0 === f ? h : f),
        "deltaY" in r && (c = f = -1 * r.deltaY),
        "deltaX" in r && ((h = r.deltaX), 0 === f && (c = -1 * h)),
        0 !== f || 0 !== h)
      ) {
        if (1 === r.deltaMode) {
        ...
        if (
          ((o = Math.max(Math.abs(f), Math.abs(h))),
          (!i || o < i) && u(r, (i = o)) && (i /= 40),
          u(r, o) && ((c /= 40), (h /= 40), (f /= 40)),
          (c = Math[1 <= c ? "floor" : "ceil"](c / i)),
  ...
  (function (e) {
    ...
    var x,
      ...
      O = "inline",
      E = function () {
        D && (C.after(D.addClass(x)).detach(), (D = null));
      };
        ...
        getInline: function (i, n) {
          if ((E(), i.src)) {
            ...
            if (s.length) {
              ...
              r &&
                r.tagName &&
                (C || ((x = o.hiddenClass), (C = w(x)), (x = "mfp-" + x)),
                (D = s.after(C).detach().removeClass(x))),
          ...
          return (
            ...
            !(!i || !i.enabled) &&
              ...
              _("UpdateStatus" + o, function (e, i) {
                i.text &&
                  (i.text = $(i.text, t.currItem.index, t.items.length));
              }),
...
var positionParallax = function (e, t, i, n) {
  ...
  calculateHeight = function (e, t) {
    for (var i = 0; e.length > i; i++) {
      var n = e[i].parentElement.parentElement.getBoundingClientRect(),
        ...
        r =
          windowHeight > n.height + o
            ? n.height + o - o / t
            : n.height + 2 * (s - s / t);
      (e[i].style.height = r + 2 * windowHeightExtra + "px"),
        positionParallax(n, t, e, i);
    }
  },
  universalParallax = function () {
    this.init = function (e) {
      ...
      for (
        var t = document.getElementsByClassName(e.className), i = 0;
        t.length > i;
        i++
      ) {
        ...
        void 0 !== s &&
          ((t[i].style.backgroundImage = "url(" + s + ")"),
          1 === t[i].classList.length &&
            "parallax" === t[i].classList[0] &&
            ((t[i].style.backgroundRepeat = "no-repeat"),
            (t[i].style.backgroundPosition = "center"),
            (t[i].style.backgroundSize = "cover")));
      }
      document.addEventListener("readystatechange", function (i) {
        var n, o;
        "complete" === i.target.readyState &&
          ((n = t),
          (o = e.speed) < 1 && (o = 1),
          calculateHeight(n, o),
          mobile ||
 ...
 * https://wowjs.uk
 * Copyright (c) 2016 Thomas Grainger; Licensed MIT */ !(function (e, t) {
      ...
      return (
        l(e, [
            ...
            value: function (e) {
              return (
                ...
                this.config.resetAnimation &&
                  (o(e, "animationend", this.resetAnimation),
          ...
          },
          {
            ...
            value: function (e, t) {
              for (
                var i = c(e), n = i.getPropertyCSSValue(t), o = 0;
